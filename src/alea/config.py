...
settings = [
        ...
        ('bot', 'home_clan_id', 'int', 2047004929,
        ...
        ('limits', 'private_perplayer_burst', 'int', 3,
            ...
            0 to disable"""),
        ('limits', 'public_perplayer_limit', 'int', 120,
        ...
        ('chatter', 'helptext', 'stringchoice',
            ['To roll in private: /msg kimmybot roll 1dX. To roll in public: /msg kimmybot roll 1dX in games. More documentation will be in DC as it is available.'],
            """Response for helprequest"""),

        ('chatter', 'hellotext', 'stringchoice',
            ['Greetings, %P! How can I assist?'],
        ...
        ('chatter', 'kmailtext_arrow_notattached', 'stringchoice',
            ['I tried to interpret this message as an arrow request, but there was no arrow attached. Please attach an arrow so that I can shoot you.'],
            """Response for kmailed arrow request with no arrow attached"""),
        ('chatter', 'kmailtext_arrow_extraattached', 'stringchoice',
            ['I tried to interpret this message as an arrow request, but there were additional items or meat attached. Please only attach an arrow so that I can shoot you.'],
            """Response for kmailed arrow request with extra goodies attached"""),
        ('chatter', 'kmailtext_donate_thanks', 'stringchoice',
            ['Hi %P, thank you very much for giving me your stuff and/or meat! It is very appreciated.'],
        ...
        ('chatter', 'kmailtext_quote_ronin', 'stringchoice',
            ['You sent some items and meat which I tried to return, but you are in Hardcore or Ronin. Contact KimmyJ if you need them back.\nHere is a copy of your message:'],
        ...
        ('chatter', 'error_public_perplayer_limit', 'stringchoice',
            ['Sorry, you have to wait for one minute since the last public roll.'],
        ...
        ('chatter', 'error_expression_too_many_dice', 'stringchoice',
            ['More than 1000 dice in one formula? NOOOOOOOPE.'],
        ...
        ('chatter', 'error_arrow_self', 'stringchoice',
            ...
            """Error message when arrow target is kimmybot"""),
        ...
        ('chatter', 'error_bad_syntax', 'stringchoice',
            [
                'I didn\'t quite catch that. Try again with clearer English.',
                'Do what with the what, now?',
                'No comprende, amigo.',
                'Come again? (That\'s what she said.)',
                'You\'ve confused me. Try /msg kimmybot help?'
            ],
